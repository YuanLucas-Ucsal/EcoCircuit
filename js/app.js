            ...
            {toast && (
                <div className={`fixed bottom-5 right-5 z-[2000] view-transition flex items-center gap-3 px-4 py-3 rounded-2xl shadow-2xl border min-w-[280px] transition-colors duration-300 ${
                    ...
                    <div className={`w-8 h-8 rounded-xl flex items-center justify-center text-sm ${
                        toast.type === 'success' 
                            ? (theme === 'dark' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'bg-emerald-100 text-emerald-600 border border-emerald-200') 
                            : toast.type === 'error' 
                            ? (theme === 'dark' ? 'bg-red-500/10 text-red-400 border border-red-500/20' : 'bg-red-100 text-red-600 border border-red-200') 
